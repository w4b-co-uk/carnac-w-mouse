...
namespace Carnac.Logic.Models {
    public sealed class KeyPress: KeyPressDefinition {
        ...
        public bool HasModifierPressed => InterceptKeyEventArgs.AltPressed
        ...
        private static string Format(string text, bool isShortcut) {
            ...
            return text == " " && isShortcut ? "Space" : text;
        }
        ...
        public override bool Equals(object obj) {
            return !(obj is null) && (ReferenceEquals(this, obj) || (obj.GetType() == GetType() && Equals((KeyPress)obj)));
        }
        ...
        private bool Equals(KeyPress other) {
